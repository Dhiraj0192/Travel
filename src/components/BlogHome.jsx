          ...
          {featuredPosts.slice(0, 4).map((post) => (
            ...
            >
              ...
              <div className="p-6 bg-white">
                ...
                <button className="mt-4 flex items-center text-indigo-600 font-medium hover:text-indigo-800 transition-colors">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {trendingPosts.map((post) => (
            ...
            >
              ...
              <div className="flex text-md justify-between items-center  text-white">
                <span className="font-bold">{post.date}</span>
                <span className="text-green-400 font-bold">{post.readTime}</span>
              </div>
            </div>
          ))}
        </div>
