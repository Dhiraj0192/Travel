...
const RecentPendingBlog = () => {
  const limit = 10;
  const [refreshDataPost, setRefreshDataPost] = useState(false)
  const { data: allBlogs } = useFetch(
    `${getEnv("VITE_API_BASE_URL")}/dashboard/get-all-pending-blog?limit${limit}`,
    {
      method: "get",
      credentials: "include",
    },[refreshDataPost]
  ...
  return (
    <div className="p-6 w-full bg-gray-600 rounded-lg shadow-sm mt-6 mb-6">
      <div className="flex items-center justify-between mb-3">
        <h2 className="text-xl font-semibold text-white">Recent Pending Blogs</h2>
...
export default RecentPendingBlog;
