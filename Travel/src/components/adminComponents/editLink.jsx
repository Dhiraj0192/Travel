...
const {
  ...
  useEffect(() => {
      if (otherData) {
        ...
        form.setValue("number", otherData.number);
        form.setValue("email", otherData.email);
        form.setValue("location", otherData.location);
  ...
  async function onSubmit(values) {
    try {
      ...
      const response = await fetch(`${getEnv("VITE_API_BASE_URL")}/other/update/${values?.number}/${values?.email ? values?.email : "null"}/${values?.location ? values?.location : "null"}`, {
        method: "post",
        credentials: "include",
