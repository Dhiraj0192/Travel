...
function SinglePostEditAdvertise() {
  ...
  async function onSubmit(values) {
    try {
      ...
      const response = await fetch(
        `${getEnv("VITE_API_BASE_URL")}/advertise/singlepost/update/${advertiseid.advertise_id ? advertiseid.advertise_id : id}`,
        {
          method: "put",
          credentials: "include",
          body: formData,
...
export default SinglePostEditAdvertise;
